...
exports.metadata = function (source, tags, exiftoolCmd, doneGettingMetadata) {
  // tags is an optional parameter, hence it may be a callback instead.
  if (typeof tags == 'function') {
    doneGettingMetadata = tags;
    tags = [];
  }
  if (typeof exiftoolCmd == 'function') {
    doneGettingMetadata = exiftoolCmd;
    exiftoolCmd = undefined;
  }
  ...
  var exif = ChildProcess.spawn(cmd, tags);
